      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
        ...
        >
          <div className="text-4xl sm:text-5xl mb-4 transition-transform duration-300 group-hover:scale-110">
            <span className="inline-block bg-indigo-100 p-4 rounded-full">🎓</span>
          </div>
          ...
          <div>
            <Button 
              className="w-fit px-6 py-3 bg-gradient-to-r from-indigo-600 to-indigo-500 hover:from-indigo-700 hover:to-indigo-600 text-white text-sm font-semibold rounded-full shadow-md hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1"
            >
              Sign Up as Student
            </Button>
          </div>
        ...
        >
          ...
          <div>
            <Button 
              className="w-fit px-6 py-3 bg-gradient-to-r from-gray-800 to-gray-700 hover:from-gray-900 hover:to-gray-800 text-white text-sm font-semibold rounded-full shadow-md hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1"
            >
              Register as Tutor
            </Button>
          </div>
